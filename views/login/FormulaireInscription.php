...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/client/FormulaireInscription.css">
...
<body>
    ...
    <section class="signup-container">
        <form class="signup-form" action="../../models/CRUD/inscription/CreateInscription.php" method="post">
