...
<head>
    ...
    <link rel="stylesheet" href="../../../public/assets/css/administrateur/Parcelle.css">
    <link rel="stylesheet" href="../../../public/assets/css/administrateur/ModalUpdateParcelle.css">
...
<?php session_start(); ?>
            ...
            <tbody>
                ...
                <?php foreach($parcelles as $parcelle) : ?>
                    <tr>
                        ...
                        <form action="../../../models/CRUD/administrateur/Parcelles/SuppressionParcelles.php" method="post">

                            <input type="hidden" name="id_parc" value="<?php echo $parcelle['Id_parc']; ?>">
                            <button class="btn delete-btn" type="submit">Supprimer</button>

                        </form>
                        <form action="../../../models/CRUD/administrateur/Parcelles/SelectPartielleParcelle.php" method="post">
    ...
    <div class="form-container" id="modal1">
        ...
        <form action="../../../models/CRUD/administrateur/Parcelles/ModificationParcelles.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-container" id="modal2">
        ...
        <form action="../../../models/CRUD/administrateur/Parcelles/CreateParcelles.php" method="post" enctype="multipart/form-data">
