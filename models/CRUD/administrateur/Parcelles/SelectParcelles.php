...
try {
            ...
            $sqlQuery = "SELECT info_parc.Id_parc, info_parc.Id_res, users.User_id, Taille_parc, Nom_parc, Prix_parc, Status_parc, Exposition, Equipements, Preferences, Description, Chemin_image
                FROM info_parc 
