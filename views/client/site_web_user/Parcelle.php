...
<body>
    ...
    <?php require_once(__DIR__.'/../../../models/CRUD/client/parcelles/SelectSpecifiqueParcelle.php')?>
    ...
    <section class="parcelles">
        <div class="card" onclick="ouvrirModal('<?php echo $MyParcelle['Id_parc'];?>')">
            <?php $imagePath = str_replace(["../../Upload/", "../../../public/uploads/"], "../../../public/uploads/", $MyParcelle['Chemin_image']); ?>
            <img src="<?php echo $imagePath;?>" alt="Image de la parcelle">
            <div class="card-content relative p-4 top-[10px] tracking-wide">

                <h3 class="relative bottom-[15px] font-bold text-[25px]"><?php echo $MyParcelle['Id_parc'];?></h3>

                <p><?php echo $MyParcelle['Taille_parc'];?>m²</p>
                <p><?php echo $MyParcelle['Prix_parc'];?>Rs/mois</p>
                ...
                <p class="date-fin relative top-[10px]" data-date="<?php echo htmlspecialchars($MyParcelle['Date_limite']);?>">
    ...
    <?php foreach($MyParcelles as $MyParcelle):?>
        <div id="<?php echo $MyParcelle['Id_parc'];?>" class="modal">
            <div class="modal-content">
                ...
                <h2 class="font-bold text-[25px]"><?php echo $MyParcelle['Id_parc']?></h2>
                ...
                <a href="../tableauDeBord/Controle.php?id_parc=<?php echo $MyParcelle['Id_parc']?>">
                    <?php $imagePath = str_replace(["../../Upload/", "../../../public/uploads/"], "../../../public/uploads/", $MyParcelle['Chemin_image']); ?>
                    <img src="<?php echo $imagePath;?>" alt="Image du parcelle" class="rounded-[8px] w-[300px] h-auto">
                </a>
                ...
                <p><strong>Prix : </strong><?php echo $MyParcelle['Prix_parc'];?>Rs/mois</p>
                ...
                <?php if($MyParcelle['Date_limite'] <= $today):?>
                    ...
                    <form action="../../../models/CRUD/client/reservations/SelectReservationToRenewal.php" method="post">
    ...
    <script src="../../../public/assets/javascript/client/Parcelle.js"></script>
</body>
</html>
