...
*/
const char* mqtt_server = "192.168.100.117"; // C'est l'ip de mon pc qui est utilisé comme hôte du serveur mosquitto (le serveur broker) pour assurer la communication sous protocole MQTT
