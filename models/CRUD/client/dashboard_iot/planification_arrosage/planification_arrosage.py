from sqlalchemy import Column, Boolean, String, Date, Time, Integer, ForeignKey
...
class PlanificationModel(Base):
    ...
    Intervalle_rep = Column(Integer, nullable=True)
    Nombre_freq = Column(Integer, nullable=True)
    Status = Column(String(15), nullable=False, default="Actif")

    # Celui-là est une constructeur pour me permettra d'initialiser la valeur des champs de ma table  
    def __init__(self, id_planning, id_parc, duree_arrosage, date_arrosage, heure_arrosage, intervalle_rep, nombre_freq):
        ...
        self.Intervalle_rep = intervalle_rep
        self.Nombre_freq = nombre_freq
