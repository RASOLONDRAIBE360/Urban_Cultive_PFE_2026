...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/client/PresentationSite.css">
...
<body>
    ...
    <?php require_once(__DIR__."/../header_introduction/Header.php");?>
    ...
    <section class="parcelles" id="Parcelles">
        ...
        <?php require(__DIR__."/../../models/CRUD/parcelle/SelectParcelleIntroduction.php");?>
        ...
        <?php foreach($parcellesAffichees as $parcelle) :?>
            <?php
            $imagePath = str_replace("../../Upload/", "../../public/uploads/", $parcelle['Chemin_image']);
            $imagePath = str_replace("../../../public/uploads/", "../../public/uploads/", $imagePath);
            ?>
    ...
    <script src="../../public/assets/javascript/client/PresentationSite.js"></script>
