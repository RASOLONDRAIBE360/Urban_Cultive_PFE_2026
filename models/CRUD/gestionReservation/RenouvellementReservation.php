...
<body>
  ...
  <?php session_start();?>
  <button class="avis-btn" onclick="window.location.href='../../../views/client/site_web_user/Parcelle.php?showModal=<?php echo $_SESSION['id_parc'];?>'">Retour</button>
  ...
  <section class="reservation-section">
    <div class="container">
        ...
        <form action="../client/reservations/UpdateRenouvellementReservation.php" method="post" class="reservation-form">
