...
<body>
  ...
  <button class="avis-btn" onclick='window.location.href="../../../views/client/site_web_user/Reservation.php"'>Retour</button>
  ...
  <section class="reservation-section">
    <div class="container">
      ...
      <form action="../client/reservations/UpdateReservation.php" method="post" class="reservation-form">
