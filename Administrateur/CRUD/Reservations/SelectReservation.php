...
require_once (__DIR__.'/../../../Config/MySQL.php');
        ...
        try {
            ...
            $sqlRequest = "SELECT reservation_parc.Id_res, Email, reservation_parc.Id_parc, Nom_parc, Taille_parc, Prix_parc, Date_res, Duree_res, Date_fin, Date_limite, Status_res, Status_envoie 
