...
<body>
    <?php session_start(); ?>
    <?php require_once(__DIR__.'/../../../models/CRUD/administrateur/Locataires/SelectLocataires.php')?>
            ...
            <tbody>
                <?php foreach($listeUtilisateurs as $utilisateur) : ?>
                    <tr>
                        ...
                        <td>
                            <form action="../../../models/CRUD/administrateur/Locataires/SelectPartielleLocataires.php" method="post">
                            ...
                            <form action="../../../models/CRUD/administrateur/Locataires/SuppressionLocataires.php" method="post">
...
<div class="form-container" id="modal1">
    ...
    <form action="../../../models/CRUD/administrateur/Locataires/ModificationLocataires.php" method="post">
