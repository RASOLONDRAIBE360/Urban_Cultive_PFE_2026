...
*/
const char* mqtt_server = "11.0.0.19"; // C'est l'ip de mon pc qui est utilisé comme hôte du serveur mosquitto (le serveur broker) pour assurer la communication sous protocole MQTT
